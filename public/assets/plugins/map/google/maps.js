        ...
        function placeMarkers(markers){
            ...
            for (i = 0; i < markers.length; i++) {
                ...
                if (markers[i]["marker_image"] != undefined) {
                    ...
                    thumbnailImage = path+"assets/plugins/map/google/default.png";
                }
                ...
                $.ajax({
                    ...
                    success: function(results){
                        gmapAdBoxOptions = {
                            ...
                            closeBoxURL: path + "assets/plugins/map/google/close-btn.png",
            ...
            var clusterStyles = [
                {
                    url: path+'assets/plugins/map/google/cluster.png',
                    height: 36,
                    width: 36
                }
            ];
...
function simpleMap(_latitude, _longitude, element, markerDrag, place) {
    ...
    function drawMap(mapCenter) {
        ...
        var marker = new RichMarker({
            ...
            content: "<img src=" + site_url + "assets/plugins/map/google/img/marker.png>",
            flat: true
        });
